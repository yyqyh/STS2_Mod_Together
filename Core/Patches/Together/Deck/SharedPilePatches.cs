...
/// <b>为什么用 Postfix 去重、而不是 Prefix 跳过回声</b>：这个方法里还有<b>应当逐玩家生效</b>的部分
...
/// 另外 <see cref="TogetherPair.Arm" /> 激活配对时也会对齐一次：<b>读档/重连走 <c>FromSerializable</c>，
/// 那条路根本不会调 <c>ApplyEffectsTo</c></b>，否则早先存下来的"两张进阶之灾"会被原样带回来。
/// </remarks>
